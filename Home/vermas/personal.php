...
<style>
    ...
    .nav-link {
        color: #005C43; /* Color del texto de los tabs no seleccionados */
    }

    .nav-link.active {
        color: white; /* Color del texto del tab seleccionado */
        background-color: #005C43; /* Color de fondo del tab seleccionado */
        border-radius: 15px 15px 0 0; /* Borde redondeado en la parte superior */
    }

    .nav-link:hover {
        color: #003c31; /* Color del texto al pasar el mouse */
